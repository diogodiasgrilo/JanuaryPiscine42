...
/*   Updated: 2023/02/05 20:34:06 by diogpere         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// Frees the memory allocated for the shown 4x4 grid at
...
/* Fills up each row that was allocated for the grid with a
	 NULL character so that there are no junk numbers in memory
...
// Prints the 4x4 magic square to the terminal once it
// is completely properly filled.
void	printer(char **collums)
{
	int	i;
	int	j;
...
/* Allocates memory for the 4x4 magic square and calls the
 functions needed to input the right numbers according to
  the views given to the program. */
