...
/*   Updated: 2023/02/08 09:06:11 by diogpere         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// Finds any numbers that are duplicated in a row and returns the collum
//  that the duplicated number was in.
...
// Fills up the grid (without checking for duplicates yet) with the first
//  combination that is available from the COMBINATOR function in "combinator.c".
...
// Searches for duplicates in the grid and calls the COMBINATOR function for
// another combination different than any that the program has already tried for the collum.
...
// Is the main function that controls all the other functions that help with
//  finding duplicates and switching their collumn out for a different combination.
