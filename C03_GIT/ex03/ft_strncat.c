...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/01/30 08:22:47 by diogpere          #+#    #+#             */
/*   Updated: 2023/01/30 09:04:29 by diogpere         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	if (ft_dest != ft_buff)
// 	printf("[1] KO,
// 	return (value from ft_strncat is different 
//  of ft_dest. ft_strncat=%p ft_dest=%p\n",
// 	ft_buff, ft_dest));
// 	else if (strcmp(buff, ft_buff) != 0)
// 	{
// 	printf("[1] KO,
// strcmp between ft_dest and dest is different of 0(%d)\n",
// strcmp(buff, ft_buff));
// 	return (1);
// 	}
// 	else
...
// 	if (ft_dest != ft_buff)
// 	printf("[2] KO,
// return (value from ft_strncat is different of 
// ft_dest. ft_strncat=%p ft_dest=%p\n",
// ft_buff, ft_dest));
// 	else if (strcmp(buff, ft_buff) != 0)
// 	{
// 		printf("[2] KO,
